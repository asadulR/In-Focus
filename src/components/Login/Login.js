        ...
        <div className='my-16 mx-auto container px-6'>
            <div className='max-w-[500px] mx-auto bg-gray-700 py-20 px-8 rounded-md shadow-md shadow-zinc-500'>
                <form>
                    ...
                    <input className='bg-sky-200 border-0 rounded-md my-3 w-full' type="email" name="email" placeholder='Enter your email' id="email" />
                    <p className='text-center text-lg text-white font-semibold'>Or</p>
                    <input className='bg-sky-200 rounded-md border-0 mt-3 w-full' type="email" name="user " placeholder='Enter your user name ' id="user" />
                    <input className='bg-sky-200 rounded-md border-0 mt-5 w-full' type="password" name="pass" placeholder='Enter your password' id="pass" />
